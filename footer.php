...
<div class="her-footer py-5">
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-2">
                <h3>Liên hệ</h3>
                Her online từ 8h sáng tới 23h đêm tất cả các ngày trong tuần. Bạn có thể liên lạc qua SĐT: <a
                        href="tel:0889 998 889" style="color: var(--pink)">0889 998 889</a> hoặc nhắn tin Fanpage: <a
                        href="https://www.facebook.com/hersecrets.store/" target="_blank" style="color: var(--pink)">Her.Secrets</a>
            </div>
            <div class="col-md-4 pl-md-5 mb-2">
                <h3>Hướng dẫn</h3>
                <ul class="p-0 m-0" style="list-style: none">
                    <li><a href="#">- Bảng quy đổi size</a></li>
                    <li><a href="#">- Quy định đổi trả</a></li>
                    <li><a href="#">- Tri ân khách hàng cũ</a></li>
                </ul>
            </div>
            <div class="col-md-4 mb-2">
                <h3>Follow Us</h3>
                Click theo dõi chúng tớ tại Facebook và Instagram để cập nhật những thông tin mới nhất nhé<br>
                <div class="pt-1">
                    <a href="https://www.facebook.com/hersecrets.store/" target="_blank">
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook"
                             class="her-homepage-social-icon facebook svg-inline--fa fa-facebook fa-w-16" role="img"
                    ...
                    &nbsp;
                    <a href="https://www.instagram.com/her.secrets.brashop/" target="_blank">
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram"
                             class="her-homepage-social-icon instagram svg-inline--fa fa-instagram fa-w-14" role="img"
